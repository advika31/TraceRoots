...
BUILD_JSON = os.path.join("build", "ImpactToken.json")
ADDRESS_PATH = os.path.join("build", "ImpactToken.address")
...
def main():
    ...
    deployer = accounts[0]  # admin / owner
    ...
    print(f"✅ ImpactToken deployed at {address}")
